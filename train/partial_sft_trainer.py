...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='experiments/llama-8b/dropout-0.1-lr-5e-06/english/checkpoint-200')
    parser.add_argument('--starting_layer', type=int, default=0)
    parser.add_argument('--ending_layer', type=int, default=10)
    parser.add_argument('--unfreeze_module', type=str, default='full')
    ...
    wandb.init(project="coca-cola", config=args)
    ...
    output_dir = f"./experiments/llama-{model_size}b/partial-{args.starting_layer}-{args.ending_layer}-{args.unfreeze_module}/{args.starting_language}-{args.training_language}"
